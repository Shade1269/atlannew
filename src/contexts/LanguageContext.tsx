...
const translations = {
  ar: {
    ...
    welcome: "مرحباً",
    quickActionsDescription: "اختصارات سريعة لحسابك",
    guest: "ضيف",
    merchantRole: "تاجر",
    affiliateRole: "مسوق",
    adminRole: "مدير",
    ...
    honorBoardTitle: "منصة الشرف",
    honorBoardDescription: "أكبر 50 متجر في المبيعات وأكثر المسوقين في الإحالات",
    honorBoardTopStores: "أكبر 50 متجر في المبيعات",
    honorBoardTopReferrers: "أكثر المسوقين في الإحالات",
    ...
    goalsTitle: "تقدمك نحو الأهداف",
    goalsEncouragement: "استمرّ، أنت على الطريق الصحيح",
    goalCreateStore: "إنشئ متجرك",
    goalAddProducts: "أضف المنتجات",
    goalStartMarketing: "ابدأ التسويق بمتجرك",
    goalReferrals: "الإحالات",
    faqTitle: "أسئلة شائعة",
    faqDescription: "إجابات سريعة على أكثر الأسئلة شيوعاً",
    faq1Question: "كيف أبدأ كتاجر؟",
    faq1Answer: "سجّل حساباً واختر نوع تاجر، ثم أضف منتجاتك مع الأسعار والعمولات وابدأ البيع.",
    faq2Question: "كيف أنشئ متجراً كمسوق؟",
    faq2Answer: "سجّل كمسوق، أنشئ متجرك، واختر المنتجات من التجار وأضفها لمتجرك مع رابط التتبع.",
    faq3Question: "هل الدفع والشحن آمنان؟",
    faq3Answer: "نعم. نستخدم بوابات دفع آمنة وشحن موثوق مع تتبع الطلبات.",
    testimonialsTitle: "آراء العملاء",
    testimonialsDescription: "ماذا يقول التجار والمسوقون عن المنصة",
    testimonial1Name: "أحمد المطيري",
    testimonial1Role: "تاجر",
    testimonial1Text: "منصة واضحة وسهلة. أضفت منتجاتي في دقائق والمبيعات بدأت تصل.",
    testimonial2Name: "سارة العتيبي",
    testimonial2Role: "مسوق",
    testimonial2Text: "متجري الإلكتروني جاهز بدون برمجة. العمولات تصل بانتظام.",
    testimonial3Name: "خالد الشمري",
    testimonial3Role: "تاجر",
    testimonial3Text: "دعم فني سريع وواجهة عربية احترافية. أنصح بها.",
  },
  en: {
    // Navigation
    home: "Home",
    ...
    dashboard: "Dashboard",
    welcome: "Welcome",
    quickActionsDescription: "Quick shortcuts for your account",
    guest: "Guest",
    ...
    honorBoardTitle: "Honor Board",
    honorBoardDescription: "Top 50 stores by sales and top marketers by referrals",
    honorBoardTopStores: "Top 50 stores by sales",
    honorBoardTopReferrers: "Top marketers by referrals",
    ...
    goalsTitle: "Your progress",
    goalsEncouragement: "Keep going, you're on the right track",
    goalCreateStore: "Create your store",
    goalAddProducts: "Add products",
    goalStartMarketing: "Start marketing with your store",
    goalReferrals: "Referrals",
    faqTitle: "Frequently asked questions",
    faqDescription: "Quick answers to the most common questions",
    faq1Question: "How do I start as a merchant?",
    faq1Answer: "Register an account, choose merchant type, then add your products with prices and commissions and start selling.",
    faq2Question: "How do I create a store as a marketer?",
    faq2Answer: "Register as a marketer, create your store, and choose products from merchants to add to your store with tracking links.",
    faq3Question: "Are payment and shipping secure?",
    faq3Answer: "Yes. We use secure payment gateways and reliable shipping with order tracking.",
    testimonialsTitle: "Customer reviews",
    testimonialsDescription: "What merchants and marketers say about the platform",
    testimonial1Name: "Ahmed Al-Mutairi",
    testimonial1Role: "Merchant",
    testimonial1Text: "Clear and easy platform. I added my products in minutes and sales started coming in.",
    testimonial2Name: "Sara Al-Otaibi",
    testimonial2Role: "Affiliate",
    testimonial2Text: "My online store was ready with no coding. Commissions arrive regularly.",
    testimonial3Name: "Khalid Al-Shammari",
    testimonial3Role: "Merchant",
    testimonial3Text: "Fast technical support and professional Arabic interface. I recommend it.",
  },
};
